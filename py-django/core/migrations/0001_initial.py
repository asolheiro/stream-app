    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('UPLOAD_STARTED', 'Upload iniciado'), ('PROCESS_STARTED', 'Processamento iniciado'), ('PROCESS_FINISHED', 'Processamento finalizado'), ('PROCESS_ERROR', 'Erro no processamento')], default='UPLOAD_STARTED', max_length=20, verbose_name='status')),
